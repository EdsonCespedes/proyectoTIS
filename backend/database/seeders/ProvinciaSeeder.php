...
class ProvinciaSeeder extends Seeder
{
    ...
    {
        $provincias = [
            'La Paz'      => ['Murillo', 'Ingavi', 'Pacajes','Abel Iturralde', 'Larecaja', 'Los Andes', 'Nor Yungas', 'Caranavi', 'Bautista Saavedra','Gualberto Villarroel','José Manuel Pando','Omasuyos','Pedro Domingo Murillo','Sud Yungas','Muñecas','Manco Kapac','Jose Ramon Loaysa','Inquisivi','Franz Tamayo','Eliodoro Camacho','Aroma','Abel Iturralde'],
            'Cochabamba'  => ['Cercado', 'Quillacollo', 'Chapare','Bolivar', 'Tiraque', 'Ayopaya', 'Arani', 'Tapacarí', 'Narciso Campero', 'Esteban Arce','Punata','Arque','German Jordán','Capinota','Carrasco','Mizque'],
            ...
            'Chuquisaca'  => ['Oropeza', 'Zudáñez', 'Tomina','Belisario Boeto','Hernandos Siles','Jaime Zudañez','Jose Maria Avilés','Luis Calvo','Nor Cinti','Sud Cinti','Tomina'],
